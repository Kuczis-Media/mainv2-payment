...
- [3. Chemia organiczna — quiz](/members/module/quiz/?repo=repo-testowe&quiz=quiz-chemia-organiczna) — Pięć typów pytań, w tym trzy tryby odpowiedzi otwartej.
...
## Warsztat ustawień i Enterów

> Najpierw wgraj materiały z Examples. Warianty egzaminów są szkicami — opublikuj wybrane w Studio, zanim udostępnisz je uczniom.

### Lekcja i quizy

- [Lekcja po kolei — Entery i blokada edycji](/members/module/lesson/?repo=repo-testowe&file=lekcja-sekwencyjna.md) — Zadanie ABCD w kilku wierszach; warunek przejścia i odpowiedź z blokadą edycji.
- [Quiz bez AI — wynik od razu](/members/module/quiz/?repo=repo-testowe&quiz=quiz-bez-ai) — Same odpowiedzi automatyczne.
- [Quiz refleksja — bez punktów](/members/module/quiz/?repo=repo-testowe&quiz=quiz-refleksja) — Brak oczekiwania na ocenę.
- [Asystent z JSON](/members/module/chat/?repo=repo-testowe&prompt=example-prompt.json) — Instrukcja w pliku JSON.
- [Pytania naprowadzające — TXT punkt 2](/members/module/chat/?repo=repo-testowe&plik=example-prompt.txt&punkt=2) — Wybór konkretnej instrukcji TXT.

### Motywy i postępy prezentacji

- [Jasny motyw — najwyższy slajd](/members/module/presentation/?repo=repo-testowe&presentation=prezentacja-jasna) — Porównaj postęp po pominięciu opcjonalnego slajdu.
- [Ciemny motyw 4:3 — odwiedzone slajdy](/members/module/presentation/?repo=repo-testowe&presentation=prezentacja-ciemna) — Porównaj postęp po pominięciu opcjonalnego slajdu.
- [Minimalny motyw — wymagane slajdy](/members/module/presentation/?repo=repo-testowe&presentation=prezentacja-minimalna) — Porównaj postęp po pominięciu opcjonalnego slajdu.
