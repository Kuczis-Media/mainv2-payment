(function exposeEnvModel(root, factory) {
  ...
  const PRESETS = Object.freeze([
    ...
    preset('GITHUB_SITE_ASSETS_TOKEN', 'Logo i landing', 'PAT z Contents: Read and write do publicznego Kuczis-Media/logo. Wymagany do publikacji strony i wspólnej marki; edycja lokalna i eksport HTML działają bez tokenu.', true),
    preset('GITHUB_SITE_ASSETS_DIRECTORY', 'Logo i landing', 'Opcjonalny katalog na nowe logo i obrazy; landing/config.json pozostaje w stałej ścieżce.', false),
